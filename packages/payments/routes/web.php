...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('deposits/{deposit}/track', 'DepositController@track')->name('deposits.track');
        // withdrawals
        Route::resource('withdrawals', 'WithdrawalController',  ['only' => ['index','show','edit','update']]);
