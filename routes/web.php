...
Route::name('frontend.')
    ...
    ->group(function () {
        ...
        // Raffle
        Route::get('raffle', 'PageController@raffle')->name('raffle');
        // history
        ...
        // locale
        Route::get('locale/{locale}/remember', 'LocaleController@remember')->name('locale.remember');
    });
...
Route::name('frontend.')
    ...
    ->group(function () {
        ...
        Route::get('deposits',function(){return view('frontend.pages.static.payments');})->name('payments.deposit');
        Route::get('raffle', function(){return view('frontend.pages.raffle.index');})->name('raffle.index');
        Route::get('raffle/history', function(){return view('frontend.pages.raffle.history');})->name('raffle.history');
