...
<div class="content">
	...
	<div class="fairraffle">
		<div class="raffle" style="background-image: url(<?php echo e(asset("assets/img/raffle.png")); ?>);">
			<img data-src="<?php echo e(asset("assets/img/icons/raffle big.svg")); ?>" alt="" class="raffle__logo">
